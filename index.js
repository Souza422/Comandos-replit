...
bot.on("message", msg => {
  ...
  msg.channel.send("**Meu prefixo é **`a!`") 
});
...
bot.on('ready', () => {
  ...
  var tabela = [
    { name: 'ultilize a!help para saber meus comandos (em breve)', type: 'PLAYING' },
    { name: 'ultilize a!help para saber meus comandos (em breve)', type: 'WATCHING' }
  ];
